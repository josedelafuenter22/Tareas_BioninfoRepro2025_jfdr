...
![Sumary data](images/summary.png)*Summary del estudio Cervical Cancer.*
...
![Clincal data](images/clinicaldata.png)*Clinical data del estudio Cervical Cancer.* 
...
![Grafico barras por edades](images/grafico_barras_edad.png) *Grafico de barra por edades.*
...
![Supervicencia](images/sobrevida.png) *Grafico de supervivencia.*
...
![Grafico Kaplan-Meier](images/kmplot.png) *Gráfico Kaplan-Meier.*
